...
name: "Pro",
price: "$29/mo",
features: ["Advanced AI", "Smart Routing", "5,000 tickets", "Analytics Dashboard"]
},
{
name: "Enterprise",
price: "Custom",
features: ["Full automation suite", "Unlimited tickets", "Dedicated support"]
}
];
...
>
<h2 className="text-2xl font-semibold mb-3 text-blue-600 dark:text-blue-400">{p.name}</h2>
